/* ==========================================================
   ...
   Fully filled in. Remaining steps (see SETUP.md for details):
     ...
     3. Paste the Realtime Database + Storage security rules
        from SETUP.md into their respective "Rules" tabs
...
const firebaseConfig = {
  ...
  storageBucket: "dzsscout-group.firebasestorage.app",
...
// Storage security rules (see SETUP.md) — the check here is
